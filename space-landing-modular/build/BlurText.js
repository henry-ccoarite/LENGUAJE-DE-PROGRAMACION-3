...
function BlurText({ text, className }) {
    ...
    return (React.createElement("p", { ref: ref, className: className, style: { display: "flex", flexWrap: "wrap", justifyContent: "center", rowGap: "0.1em" } }, words.map((word, i) => (React.createElement(motionBlur.span, { key: i, initial: { filter: "blur(10px)", opacity: 0, y: 50 }, animate: visible
            ? {
            ...
            ease: "easeOut",
            delay: (i * 100) / 1000,
        }, style: { display: "inline-block", marginRight: "0.28em" } }, word)))));
}
