...
function FadingVideo({ src, className, style }) {
    ...
    return (React.createElement("video", { ref: videoRef, className: className, style: Object.assign({ opacity: 0 }, style), autoPlay: true, muted: true, playsInline: true, preload: "auto", src: src }));
}
