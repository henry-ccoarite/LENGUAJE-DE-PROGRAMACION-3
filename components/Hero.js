...
window.Hero = function Hero() {
    ...
    return ( <
        ...
        <
        motion.div className = "liquid-glass rounded-full flex items-center gap-2 mb-6"
        initial = {
        ...
        <
        motion.p className = "mt-4 text-sm md:text-base text-white max-w-2xl text-center font-body font-light leading-tight"
        initial = {
            { filter: 'blur(10px)', opacity: 0, y: 20 }
        }
        animate = {
        ...
        <
        motion.div className = "flex items-center gap-6 mt-6"
        initial = {
            { filter: 'blur(10px)', opacity: 0, y: 20 }
        }
        animate = {
        ...
        transition = {
            { duration: 0.8, delay: 1.1, ease: 'easeOut' }
        } >
        <
        ...
        <
        motion.div className = "flex items-stretch gap-4 mt-8"
        initial = {
            { filter: 'blur(10px)', opacity: 0, y: 20 }
        }
        animate = {
        ...
        transition = {
            { duration: 0.8, delay: 1.3, ease: 'easeOut' }
        } >
        <
        ...
        <
        motion.div className = "flex flex-col items-center gap-4 pb-8 px-4"
        initial = {
            { filter: 'blur(10px)', opacity: 0, y: 20 }
        }
        animate = {
